...
(
  ...
  echo "Appending '${cluster_name_key}' '${resource_group_id_key}' input variable values to ${JSON_FILE}.."
  ...
  '. + {($cluster_name_key): $cluster_name_value, ($resource_group_id_key): $resource_group_id_value}' \
